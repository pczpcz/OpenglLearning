...
void display() 
{
    ...
    static int iCount = 0;
    iCount += 10;
    if (iCount > 360) iCount = 0;
    glm::mat4 trans;
    trans = glm::translate(trans, glm::vec3(0.5, -0.5, 0.0));
    trans = glm::rotate(trans, glm::radians((float)iCount), glm::vec3(0.0, 0.0, 1.0));

    GLuint uniformTrans = glGetUniformLocation(shaderProgram, "trans");
    glUniformMatrix4fv(uniformTrans, 1, GL_FALSE, glm::value_ptr(trans));
